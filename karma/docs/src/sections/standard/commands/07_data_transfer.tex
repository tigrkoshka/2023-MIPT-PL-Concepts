...
\cmdtable{Data transfer commands} {
    ...
    40 & \St{mov} & \Ss{RR} & \RRcmd{mov}{r0}{r3}{10} &
    \St{$\text{r0} = \text{r3} +\text{10}$} \\

    \hline

    41 & \St{load} & \Ss{RM} & \RMcmd{load}{r3}{0xffc2} &
    \St{$\text{r3} = {}^*(\text{0xffc2})$} \\

    \hline

    42 & \St{load2} & \Ss{RM} & \RMcmd{load2}{r4}{13224} &
    \cmdcellalign{
        \text{r4} = {}^*(\text{13224}) \\
        \text{r5} = {}^*(\text{13225}) \\
    } \\
    ...
    43 & \St{store} & \Ss{RM} & \RMcmd{store}{r1}{057123} &
    \St{${}^*(\text{057123}) = \text{r1}$} \\

    \hline

    44 & \St{store2} & \Ss{RM} & \RMcmd{store2}{r0}{0X15fc} &
    \cmdcellalign{
            {}^*(\text{0X15fc}) = \text{r0} \\
        {}^*(\text{0X15fd}) = \text{r1} \\
    } \\
    ...
    45 & \St{loadr} & \Ss{RR} & \LongRRcmd{loadr}{r8}{r1}{15} &
    \St{$\text{r8} = {}^*(\text{r1} + \text{15})$} \\

    \hline

    46 & \St{loadr2} & \Ss{RR} & \LongRRcmd{loadr2}{r2}{r0}{12} &
    \cmdcellalign{
    ...
    47 & \St{storer} & \Ss{RR} & \LongRRcmd{storer}{r2}{r3}{3} &
    \St{${}^*(\text{r3} + \text{3}) = \text{r2}$} \\

    \hline

    48 & \St{storer2} & \Ss{RR} & \LongRRcmd{storer2}{r5}{r2}{13} &
    \cmdcellalign{
